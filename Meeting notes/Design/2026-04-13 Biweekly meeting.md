...
### Peamised punktid
- **Komponentide uuendused:** alertidele lisati slotid tegevusnuppude ja linkide jaoks; AutoGrow text fieldile parandab kasutajamugavust.
- **Pagination parandus:** Vaikimisi aktiivne number on nüüd 1 (mitte 2), mis vähendab käsitsi kohandamise vajadust projektides.
- **AI integratsioon Figmas:** Kärolin tutvustas Figma Make, Figma ja Claude'i integratsiooni – AI suudab luua vaateid TEDI komponente kasutades. Figma make vajab täpsemaid stiili- ja värvijuhiseid ning on tokenipiirangu tõttu aeglane.
- **Dropdownide dokumenteerimine:** Mitmikvaliku ja üksikvaliku visuaalset erinevust hetkel ikooniga ei eristata – ei hakata ka neid eristama.
...
## Päevakord
- Komponentide uuendused: AutoGrow, alertide slotid, pagination, spinneri suurused täiendatud, textarea min height muutus (nii figmas kui arenduses)
- AI prototüüpimine Figma Make ja Claude'iga
- Dropdownide ikonograafia ja valikurežiimide eristamine - kas vajalik?
- Filterkomponendi arendusjärjekord Reactis
...
- Dropdownide puhul ei eristata mitmikvalikut ja üksikvalikut ikooniga – kasutajale selgub valikutüüp alles menüü avanemisel, mis on tavapärane lahendus.
- Filterkomponent on Angularis arenduses, kuid Reacti versiooni prioriteet on lahtine – Pireti projekt ootab Reacti filtrit.
...
- Iga nädala alguses toimub TEDI tuumiktiimil prioriteetide ülevaatus, kus kasutajate häälestus ja projekti vajadused määravad arendusse tulevate ülesannete järjekorra
- Figma support kanal on loodud Figma-spetsiifilisteks küsimusteks ja teadmiste jagamiseks
...
- Jagada lahendusi ja kogemusi rahastuslogode kuvamise kohta
- Jagada teadmisi ja lahenduse TEDI ja AI koostöö kohta
